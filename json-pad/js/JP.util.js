JP.util = {
	...
	debug.trace("__"+JPAir.preferences.settings.app.jsonValidateLevel);
	var lint = JSLINT(string, {
	    script: (JPAir.preferences.settings.app.jsonValidateLevel != "strict")
	});
    ...
    type: function ( val ) {
	air.trace(" GET TYPE FROM === " + val + " && TYPE IS == " + Ext.type(val) + " -.-");
