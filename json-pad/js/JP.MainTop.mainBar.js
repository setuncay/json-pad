JP.MainTop.mainBar = Ext.extend(Ext.Toolbar, {
	...
	this.items = [
	{
		...
		{
		    text: 'New',
		    statusBarTip: 'Clear the tree and the textarea',
		    ref: 'clear'
		},
		'-',
		{
	...
	this.file.menu.clear.setHandler( JP.MainTop.Action.mainBar.clearApplication );
	...
	this.help.menu.settings.setHandler( JP.MainTop.Action.mainBar.openSettingsWindow, this );
